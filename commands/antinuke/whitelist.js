...
module.exports = {
  ...
  run: async (client, message, args) => {
    const wl = new MessageEmbed()
      ...
      .addFields([
        { name: `__**Usage**__`, value: `<a:s_dot:1093784644740194304> \`${message.guild.prefix}whitelist @user\`\n<a:s_dot:1093784644740194304> \`${message.guild.prefix}wl @user\`` }
      ])
...
Oh NO! looks like your server doesn't enabled security
