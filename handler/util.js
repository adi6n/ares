...
module.exports = class Util {
  ...
  async buildGreeting(member, type, config) {
    ...
    if (!config.content && !config.embed.description && !config.embed.footer) {
      return { content: `<@${member.user.id}>`, embeds: [new MessageEmbed().setColor(this.client.color).setDescription(`Hey ${member.displayName}, Welcome to the server .<a:s_welc_1:1093800555333308416><a:s_welc_2:1093800616578519090>`)] };
    }
